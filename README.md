...
本專案使用 BRFSS2015 健康指標數據集來預測糖尿病風險。我採用了多種機器學習模型進行訓練和評估，最終透過集成學習方法獲得了更高的預測準確率。

### 數據集說明

我使用了平衡的數據集 `diabetes_binary_5050split_health_indicators_BRFSS2015.csv`，其中包含相同數量的糖尿病和非糖尿病案例，以解決實際醫療數據中常見的類別不平衡問題。
